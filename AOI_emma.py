...
rect1 = patches.Rectangle((420, 600), 65, 75, linewidth=1, edgecolor='r', facecolor='none')
rect2 = patches.Rectangle((1585, 600), 65, 75, linewidth=1, edgecolor='r', facecolor='none')
